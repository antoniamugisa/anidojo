...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen relative bg-black">
      ...
      <section className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900/20 to-slate-800 flex items-center justify-center px-6 py-20">
      ...
      <section className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900/20 to-slate-800 flex items-center justify-center px-6 py-20">
        <div className="max-w-6xl w-full">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-8">
      ...
      <section className="min-h-screen bg-gradient-to-br from-slate-900 via-pink-900/20 to-slate-800 flex items-center justify-center px-6 py-20">
        <div className="max-w-6xl w-full">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="group bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-8 hover:border-white/20 hover:scale-105 transition-all duration-300 cursor-pointer"
              >
                <div className="w-full h-40 bg-gradient-to-br from-gray-700 to-gray-800 rounded-lg mb-6 flex items-center justify-center">
                  <span className="text-5xl">🎌</span>
                </div>
                <h3 className="text-xl font-bold text-white mb-3 group-hover:text-pink-400 transition-colors leading-tight">
                  {anime.title}
                </h3>
                <p className="text-gray-400 text-base mb-4">{anime.date}</p>
                <span className={`inline-block px-4 py-2 rounded-full text-sm font-semibold text-white ${anime.statusColor}`}>
                  {anime.status}
                </span>
              </div>
            ))}
      ...
      <section className="min-h-screen bg-gradient-to-br from-slate-900 via-cyan-900/20 to-slate-800 flex items-center justify-center px-6 py-20">
              ...
              >
                <div className="flex items-start space-x-6">
                  <div className="w-16 h-16 bg-cyan-500/20 rounded-full flex items-center justify-center flex-shrink-0">
                    <span className="text-cyan-400 font-bold text-xl">{review.avatar}</span>
                  </div>
                  <div className="flex-1">
                    <div className="flex items-center space-x-3 mb-3">
                      <h4 className="text-lg font-semibold text-white">{review.user}</h4>
                      <span className="text-gray-400">•</span>
                      <span className="text-cyan-400 font-medium text-lg">{review.anime}</span>
                    </div>
                    ...
                    <p className="text-gray-300 mb-6 leading-relaxed text-lg">{review.review}</p>
                    <div className="flex items-center space-x-8">
                      <button className="flex items-center space-x-2 text-gray-400 hover:text-cyan-400 transition-colors">
                        ...
                        <span className="text-base">{review.likes}</span>
                      </button>
                      <button className="flex items-center space-x-2 text-gray-400 hover:text-cyan-400 transition-colors">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                        </svg>
                        <span className="text-base">{review.replies} replies</span>
                      </button>
                    </div>
                  </div>
                </div>
