      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-6 py-24">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-10">
            ...
            <h1 className="font-display text-display-md text-cream mb-2">WELCOME BACK</h1>
            <p className="text-cream-muted">Sign in to your AniDojo account</p>
          </div>
          ...
          <div className="card-feature rounded-md p-8">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center cursor-pointer">
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-4 h-4 bg-ink border-border-medium rounded-sm text-crimson focus:ring-crimson focus:ring-offset-ink"
                  />
                  <span className="ml-2 text-sm text-cream-muted">Remember me</span>
                </label>
                <Link href="/forgot-password" className="text-sm text-jade-bright hover:text-jade transition-colors">
                  Forgot password?
                </Link>
              </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-cream-muted">
                ...
                <Link href="/signup" className="text-jade-bright hover:text-jade font-medium transition-colors">
                  Sign Up
                </Link>
              </p>
            </div>
